<template lang="jade">
  section.banner.col-xs-12.no_pad
    .bg

      .bg_text_svg
         svg#bigComma(version='1.1', xmlns='http://www.w3.org/2000/svg', xmlns:xlink='http://www.w3.org/1999/xlink', x='0px', y='0px', viewbox='0 0 1000 841.89', enable-background='new 0 0 1000 841.89', xml:space='preserve')
          g
            g
              path.bigComm(stroke-miterlimit='10', d='M97.832,345.89\
              ...
              path.bigComm(stroke-miterlimit='10', d='M554.795,341.947h-15.777v-99.773\
              ...
              path.bigComm(stroke-miterlimit='10', d='M799.141,341.947h-15.768v-99.773\
              ...
              path.bigComm(stroke-miterlimit='10', d='M944.227,322.228\
              ...
              g
                path.bigComm(d='M234.708,339.523c-0.003,0-0.003,0-0.006,0c-9.748,0-20.136-0.964-31.757-2.944l1.269-13.69\
                ...
                path.bigComm(d='M195.212,329.844c0,3.676,5.416,6.688,9.027,6.954c3.977,0.289,7.22-3.571,7.22-7.252\
                c0-3.676-2.785-6.898-7.22-6.656C200.255,323.109,195.212,326.166,195.212,329.844z')
      .img_container.col-xs-12.no_pad
        //- img.bgImg(
...
.bg{
  ...
  .bg_text_svg svg{
    ...
    -webkit-animation: bigComm 10s 0s infinite linear;
    -moz-animation: bigComm 10s 0s infinite linear;
    -o-animation: bigComm 10s 0s infinite linear;
    animation: bigComm 10s 0s infinite linear;
    }
  @keyframes bigComm{
      0%{fill:transparent;stroke-dashoffset:2000;}
     25%{fill:transparent;stroke-dashoffset:1000;} 
     50%{fill:#fff;stroke-dashoffset:0;}
     60%{fill:#fff;stroke-dashoffset:0;}
